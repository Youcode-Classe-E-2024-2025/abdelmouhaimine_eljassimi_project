...
<body class="min-h-screen flex items-center justify-center bg-gray-900">
    <div class="w-full max-w-md bg-gray-800 rounded-lg shadow-md p-8">
        ...
        <form action="?action=signin" method="POST" id="authForm" class="space-y-4">
            <div>
        ...
        <div class="mt-6">
            ...
            <div class="mt-6">
                <a href="view/login_google.php" class="w-full py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-black bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 flex items-center justify-center">
